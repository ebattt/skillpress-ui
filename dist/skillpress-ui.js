/*! @ebattt/skillpress-ui 0.9.0 -- bundle JS unico (26 moduli). Auto-init via data-attribute; per markup iniettato dopo il load usare window.SkillpressUI.init(scope). */
