...
async function measureCommon(page) {
    return page.evaluate(() => {
        ...
        const sels = {
            ...
            modeBtnInactive:    '.mode-btn--inactive, .mode-btn:not(.mode-btn--active)',
            ...
            featureBoxTitle:    '.feature-box-title',
            heroImage:          '.hero-image-container',
            heroTitle:          '.hero-title',
            priceTableSection:  '.price-table-section, #priceTableContainer',
            priceTableFull:     '.price-table-full',
            priceCellBtn:       '.price-cell-btn',
            priceQtyBtn:        '.price-qty-btn',
            priceArrowRight:    '.price-nav-arrow-horizontal.right',
            accordionFirst:     '.accordion__section, .section-header',
            mobileBar:          '.mobile-total-bar, .mobile-bar',
            stepCard:           '.step-card-item',
        };
