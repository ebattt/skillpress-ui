...
const renderTextBlock = () => `
    <section class="text-block" id="chi-siamo" aria-labelledby="landing-text-story-title">
        <h2 class="text-block__title" id="landing-text-story-title">Tipografia online Skillpress: stampa digitale e stampe online</h2>
        ...
        <h3 class="text-block__subtitle">Un numero infinito di temi</h3>
...
export default {
    ...
    parameters: {
        ...
        docs: {
            description: {
                component: 'Blocco editoriale/SEO CSS-only riusabile su landing, product page e pagine contenuto. La libreria possiede la tipografia; il CMS inserisce il testo HTML.'
            }
        }
    }
};
...
export const Default = {
    ...
    play: async ({ canvasElement }) => {
        await expect(canvasElement.querySelector('.text-block__title')).not.toBeNull();
        await expect(canvasElement.querySelectorAll('.text-block__subtitle').length).toBe(2);
    }
};
