...
- **Preview lunga: stesso comportamento del box "i".** Titolo e X restano
  ...
  applicato in modo asincrono subito dopo l'apertura; la visibilita' diventa
  immediata in apertura e resta ritardata soltanto in chiusura, così il focus
  funziona anche in Chromium Linux senza alterare l'animazione del pannello.
