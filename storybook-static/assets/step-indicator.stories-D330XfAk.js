import{t as e}from"./chunk-BvrOYcoh.js";var t=e((()=>{})),n,r,i,a,o,s,c,l,u,d,f;e((()=>{t(),{expect:n}=__STORYBOOK_MODULE_TEST__,r=({index:e,title:t,status:n,state:r=`inactive`}={})=>`
    ...
    `,i=e=>{let t=document.createElement(`div`);return t.style.padding=`1rem 0`,t.innerHTML=`
    ...
    `,t},a=[{index:1,title:`Configura`,status:`In corso`,state:`active`},{index:2,title:`Carrello`,status:`In attesa`,state:`inactive`},{index:3,title:`Pagamento`,status:`In attesa`,state:`inactive`},{index:4,title:`Carica file`,status:`In attesa`,state:`inactive`}],o={title:`Components/StepIndicator`,tags:[`autodocs`],parameters:{layout:`fullscreen`,docs:{description:{component:"Step indicator orizzontale per configuratori e flussi multi-step. CSS-only: il CMS sposta i modifier `--active`, `--inactive`, `--completed` su badge, titolo e status. Mobile-first: 2 colonne sotto 1024px, 4 colonne >=1024px. La linea di connessione e visibile solo da desktop."}}}},s={render:()=>i(a),play:async({canvasElement:e})=>{await n(e.querySelectorAll(`.step-card-item`).length).toBe(4),await n(e.querySelector(`.step-badge--active`)).toBeTruthy()}},c={render:()=>{let e=document.createElement(`div`);return e.style.padding=`1rem 0`,e.innerHTML=`
        ...
        `,e},parameters:{docs:{description:{story:"Markup verbatim dalla pagina demo `product-page-integration` (righe 512-564 di `product-page-integration/index.html`)."}}}},l={render:()=>{let e=document.createElement(`div`);return e.style.padding=`1rem 0`,e.innerHTML=`
            <div class="steps-section">
                <div class="steps-wrapper">
                    <div class="steps-container">
                        <div class="steps-line"></div>
        ...
        `,e},parameters:{docs:{description:{story:"Step 1 e 2 completati (badge verde `step-badge--completed`), step 3 attivo (badge gradient arancio + bordo card primary), step 4 in attesa."}}}},u={render:()=>i([{index:1,title:`Configura`,status:`Completato`,state:`completed`},{index:2,title:`Carrello`,status:`In corso`,state:`active`},{index:3,title:`Pagamento`,status:`In attesa`,state:`inactive`}]),parameters:{docs:{description:{story:`Variante a 3 step per CMS con meno fasi. La grid resta a 4 colonne >=1024px: la quarta cella non viene renderizzata, lo spazio rimane vuoto.`}}}},d={render:()=>i(a),parameters:{viewport:{defaultViewport:`mobile1`},docs:{description:{story:"A viewport sotto 1024px la grid passa a 2 colonne e la `.steps-line` scompare. Per vedere il rendering effettivo serve restringere la finestra del browser sotto 1024px."}}}},s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
...
}`,...d.parameters?.docs?.source}}},f=[`Default`,`ReferenceFromElementsUI`,`MidProgress`,`ThreeSteps`,`Mobile`]}))();export{s as Default,l as MidProgress,d as Mobile,c as ReferenceFromElementsUI,u as ThreeSteps,f as __namedExportsOrder,o as default};