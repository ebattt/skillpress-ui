...
Blocco tipografico editoriale/SEO riusabile su landing page, product page e pagine contenuto. La libreria possiede wrapper, larghezza, padding e tipografia; il CMS/consumer inserisce il testo HTML.
...
- `.text-block`: root max-width, padding compatto e tipografia body.
